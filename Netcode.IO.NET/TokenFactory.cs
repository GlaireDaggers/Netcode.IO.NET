...
namespace NetcodeIO.NET
{
	...
	public class TokenFactory
	{
		...
		public byte[] GenerateConnectToken(IPEndPoint[] addressList, int expirySeconds, ulong sequence, ulong clientID, byte[] userData)
		{
			...
			ulong createTimestamp = DateTime.Now.ToUnixTimestamp();
			...
			publicToken.TimeoutSeconds = (uint)expirySeconds;
